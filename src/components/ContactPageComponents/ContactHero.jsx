export const ContactHero = () => {
	return (
		<div className="bg-secondary px-4 sm:px-6 lg:px-10 py-16 lg:py-28">
			<div
				data-aos="zoom-in"
				className="flex flex-col md:flex-row justify-between items-center gap-10 py-10"
			>
				{/* Text Section */}
				<div className="w-full md:w-2/3 max-w-md mx-auto md:mx-0 text-center md:text-left">
					<h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight mb-6">
						<span className="block">Your Logistic Partner,</span>
						<span className="block text-primary font-bold">
							Ready to Assist
						</span>
					</h1>
					<p className="text-gray-600 opacity-70 text-base">
