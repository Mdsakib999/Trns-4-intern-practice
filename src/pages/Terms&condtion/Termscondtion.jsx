...
const Termscondtion = () => {
	...
	return (
		<div className="p-6 md:max-w-5xl mx-auto mt-20">
			{/* Impressum Section */}
			<section className="mb-10">
				...
				<p className="mb-2 text-base sm:text-lg">
					<strong>ECML Logistik GmbH</strong>
					<br />
					Hamburger Straße 182, 22083
					<br />
					Hamburg
				</p>
				<p className="mb-2 text-base sm:text-lg">
					<strong>Telefon: </strong>{" "}
					<a href="tel:+494074303412" className="">
						+494074303412
					</a>
					<br />
					<strong>E-Mail: </strong> info@ecmllogistik.com
				</p>
				<h2 className="text-lg sm:text-xl md:text-2xl font-semibold mt-4 mb-2">
					Vertretungsberechtigter
				</h2>
				<p className="mb-2 text-base sm:text-lg">
					Geschäftsführer: Bajram Hoti
				</p>
				<h2 className="text-lg sm:text-xl md:text-2xl font-semibold mt-4 mb-2">
					Registereintrag
				</h2>
				<p className="mb-2 text-base sm:text-lg">
					...
					<br />
					<strong>Registernummer:</strong> HRB 168577
				</p>
				{/* <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mt-4 mb-2">
